...
export function BandPhoto({
  ...
  if (pinned) {
    // The frame covers the window, so the picture is as wide as the window —
    // or, on a window narrower than the photograph's shape, as wide as the
    // window's height stretched to that shape.
